...
import {visibilityFromCloud} from "../../database/Articles";

export default function ContentScheduleArticles() {
  //state for cloud function data:
  ...
  const {finishedArticles, setFinishedArticles, unfinishedArticles, setUnfinishedArticles, contentDate, sectionContent, sourceContent} = useContext(ContentContext);
    ...
    useEffect(() => {
      ...
      //for cloud function:
      visibilityFromCloud("Section Staff").then((data) => setCloudData(data))
  ...
  if (finishedArticles === undefined && unfinishedArticles === undefined) {
    ...
    return (
      <>
        {/*This line console logs data generated by a cloud function*/}
        {console.log("Number of ideas only visible to Section Staff: ", cloudData)}
